...
def insert_user_record(user_id: int, first_name: str, last_name: str, email: str, password: str):
    """
    ...
    try:
        ...
        query = """
            ...
            VALUES (?, ?, ?, ?, ?)
        """
        cursor.execute(query, (user_id, first_name, last_name, email, encrypted_password))
        conn.commit()
